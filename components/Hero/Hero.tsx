...
const Hero = () => {
  return (
    <div className="z-10 min-h-[calc(100svh-65px)] px-4 py-6 mx-auto overflow-x-hidden flex flex-col-reverse md:flex-row items-center justify-center relative text-primary gap-6 md:gap-12 lg:gap-24">
      <div>
        <motion.h1
        ...
        <motion.div
          ...
          className="buttons flex flex-col items-stretch md:flex-row md:items-center gap-2 justify-center"
        >
